...
@XmlRootElement(name = "ImageIdList", namespace = "http://www.example.org/ImageIdList")
public class ImageIdList {

    @XmlElement(name = "ImageRef", namespace = "http://www.example.org/ImageIdList", type = Long.class)
