...
@XmlRootElement(name = "Category", namespace = "http://www.example.org/Category")
public class Category {

    @XmlElement(name = "Name", namespace = "http://www.example.org/Category")
    protected String name;
    @XmlElement(name = "Desc", namespace = "http://www.example.org/Category")
    protected String desc;
    @XmlElement(name = "ImageCount", namespace = "http://www.example.org/Category")
    protected Integer imageCount;
    @XmlElement(name = "LastChanged", namespace = "http://www.example.org/Category")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar lastChanged;
    @XmlElement(name = "SystemOwned", namespace = "http://www.example.org/Category")
