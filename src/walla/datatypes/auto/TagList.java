...
@XmlRootElement(name = "TagList", namespace = "http://ws.fotowalla.com/TagList")
public class TagList {

    @XmlElement(name = "TagRef", namespace = "http://ws.fotowalla.com/TagList")
    protected List<TagList.TagRef> tagRef;
     ...
     * 
     */
    public List<TagList.TagRef> getTagRef() {
        if (tagRef == null) {
            tagRef = new ArrayList<TagList.TagRef>();
        }
        return this.tagRef;
    }
